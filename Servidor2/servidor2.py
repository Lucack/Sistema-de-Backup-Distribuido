    ...
    if request:
        ...
        if requestType == "GET":
            ...
            if filename == "/files":
                ...
                try:
                    files = os.listdir(f"{SERVER_NAME}/")
                    file_list = ""
                    for file in files:
                        if not ("index.html" in file or ".py" in file):
                            file_path = os.path.join(f"{SERVER_NAME}/", file)
                ...
                try:
                    ...
                    fin = open(f"{SERVER_NAME}/" + filename, openarq)
                    content = fin.read()
            ...
            try:
                ...
                newFile = open(f"{SERVER_NAME}/" + filename, "wb") 
